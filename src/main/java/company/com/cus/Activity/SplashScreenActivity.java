...
import company.com.cus.DataModel.User.UserSaved_Table;
    ...
    private boolean checkUserInLocalDatabase() {
        ...
        if (userSaved == null) {
            ...
            UserModel userModel = new UserModel(
                    userSaved.getId(), userSaved.getName(), userSaved.getPhone(),
                    userSaved.getEmail(), Utils.stringToListFavourite(userSaved.getListFavourite()));
